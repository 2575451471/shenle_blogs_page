...
![img](./images/3084836-20251207221157536-918740617.png)
- - -
```bash
...
```
![img](./images/3084836-20251207221608871-1146993047.png)

![img](./images/3084836-20251207221907537-544745420.png)
...
##  2.1 编写第一个节点（python）
![img](./images/3084836-20251207230941951-119338399.png)
(第二行更正为 ……Node)  
![img](./images/3084836-20251207231122231-1662598782.png)
...
if __name__=='__main__':
    main()
```
![img](./images/3084836-20251207232234804-139559685.png)
下面是一个ros2的一个标准的日志记录的方法，可以在ros2提供的日志可视化工具内可以看到，用作扩展调试    
![img](./images/3084836-20251207232609271-298134351.png)
- - -
###  研究下日志 
日志的级别   
```py
...
```
![img](./images/3084836-20251207233117008-253505614.png)
（时间戳是1970年距离当前的秒数）  
...
{message}: 实际的消息内容  
![img](./images/3084836-20251207233819400-2106890290.png)
...
- - -
### python功能包结构分析
![img](./images/3084836-20251208140838761-452295922.png)
...
![img](./images/3084836-20251208144622101-1775094750.png)
- - -
>实例化  
![img](./images/3084836-20251208144759578-786771541.png)
```python
classPersonNode:
...
```
![img](./images/3084836-20251208152950313-2061688092.png)
- - -
### 继承
```python
...
```
![img](./images/3084836-20251208160140938-1760381567.png)
- - -
### 多线程和回调函数  
![img](./images/3084836-20251208161354843-562613299.png)
```python
import threading
import requests
...
```
![img](./images/3084836-20251208163516036-1914481193.png)
...
## 6.1 机器人建模与仿真概述
### 6.1.1  移动机器人结构介绍
![img](./images/3084836-20251206170645915-20173963.png)
- - -
### 6.1.2 常用机器人仿真平台
1. gazebo(ros2适配)  
2. mujoco  
...
```
创造出的pdf
![img](./images/3084836-20251208181928500-923362893.png)
### rviz显示
![img](./images/3084836-20251208183135300-1858443015.png)
...
```
- - -
![img](./images/3084836-20251208190535558-1901241833.png)
`shenle@shenlepc:~$ sudo apt install ros-$ROS_DISTRO-gazebo-ros-pkgs`
- - -

![img](./images/3084836-20251208193239106-149206093.png)
![img](./images/3084836-20251208195421091-1591525413.png)
