...
```
- - -
![img](./images/3084836-20250215055948212-1500522702.png)  
在安装目录下新建两个文件夹    
在cmd窗口输入 
```bash
...
在本地生成一个静态网址  
![img](./images/3084836-20250215060831449-193728.png)
点击4000端口的网址即可访问  
- - -
...
my show：
![img](./images/3084836-20250215061407809-1617689282.png)  
- - -
8. 同步博客园  
...
(base) PS E:\apps\hexo>
```
![](./images/3084836-20260114110306878-329672286.gif)
放弃重建，回归cnblogs